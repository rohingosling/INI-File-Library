...
```
src/ini.h     Class declaration and compile-time limits.
src/ini.cpp   Full implementation.
...
Copy `src/ini.h` and `src/ini.cpp` into your project directory (or a known include path). Include the header in your source file:
